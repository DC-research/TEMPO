...
python train_TEMPO.py \
    --datasets monash,ETTm1,ETTh1,ETTm2,electricity,traffic,weather,ILI,exchange \
    --eval_data ETTm1,ETTh1,ETTm2,electricity,traffic,weather \
    --target_data ETTh2 \
    --config_path ./configs/multiple_datasets.yml \
    --stl_weight 0.001 \
    --equal $equal \
    --checkpoint ./Monash'_'$prompt/ \
